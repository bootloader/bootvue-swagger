<template>
    <div class="player">
			<div class="player-controls">
                    ...
                    <div id="download" v-show="!showVolume" v-if="downloading">
                    ...
                    <div id="loop" v-if="loopable" v-show="!showVolume" >
