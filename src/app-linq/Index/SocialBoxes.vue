        ...
        <div v-else class="social-btns">
            <span class="w-full lg:w-4/12   social-tile"
              v-for="(c,index) in channelsEnabled" v-bind:key="c.channelId+'_'+ index"> 
                ...
                <a  v-if="c.provider == 'google'" :href="$global.MyDict.c2cUrl(c)" 
                    class="btn google bg-google:before">
                    <i class="icon fab fa-google text-google"></i></a>
                <a  v-if="c.provider == 'linkedin'" :href="$global.MyDict.c2cUrl(c)" 
                    class="btn linkedin bg-linkedin:before">
                    <i class="icon fab fa-linkedin-in text-linkedin"></i></a>
                <a  v-if="c.provider == 'outlook'" :href="$global.MyDict.c2cUrl(c)" 
                    class="btn microsoft bg-microsoft:before">
                    <i class="icon fab fa-microsoft text-microsoft"></i></a>
                <a  v-if="c.contactType == 'FACEBOOK'" :href="$global.MyDict.c2cUrl(c)" 
