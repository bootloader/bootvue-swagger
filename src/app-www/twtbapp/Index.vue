	...
	<div class="container pt-24 md:pt-48 px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center">
		...
		<div class="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
			...
			<div class="flex w-full justify-center md:justify-start pb-24 lg:pb-0 fade-in">
				<img :src="`${STATIC}/App Store.svg`" class="h-12 pr-4 bounce-top-icons">
				<img :src="`${STATIC}/Play Store.svg`" class="h-12 bounce-top-icons">
			</div>
		...
		<div class="w-full xl:w-3/5 py-6 overflow-y-hidden">
			<img class="w-5/6 mx-auto lg:mr-0 slide-in-bottom" :src="`${STATIC}devices.svg`">
		</div>
...
export default {
  ...
  mounted(){
      document.body.className = "h-screen pb-14 bg-right bg-cover";
      document.body.style = "background-image:url('bg.svg');";
