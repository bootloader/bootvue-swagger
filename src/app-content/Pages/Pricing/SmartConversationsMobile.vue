                    ...
                    <tbody>
                        ...
                        <tr
                            ...
                            v-bind:class="[
                                ...
                                <td v-if="['header'].indexOf(row.type) != -1" :class="row.type" colspan="2" scope="row">{{ row.label }}</td>
        ...
        data() {
            return {
                ...
                labels: {
                    ...
                    mobApp: {label:'Agent App for IOS and Android',type:'price',hintText:'Pack of 5 Users / per year'},
